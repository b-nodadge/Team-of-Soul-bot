...
module.exports = {
    name: "청소",
    description:"채팅방 내용을 청소합니다.",
    async execute(message, args) {
      return message.reply("엉청난 버그로 점검")
        try {
            let i = 0
            const list = []
            ...
            if (!message.member.permissions.has(Permissions.FLAGS.MANAGE_MESSAGES)) return message.reply("권한이 없습니다")
